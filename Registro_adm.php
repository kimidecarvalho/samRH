...
<body>
    <header class="header">
        ...
        <nav class="nav-menu">
            <div class="dropdown">
                <a href="#" class="dropbtn">Produtos â–¾</a>
                <div class="dropdown-content">
                    <div class="dropdown-box dropdown-box-rh">
                        <h3>
                            <img src="img/sam2logo-32.png" alt="" class="logo-icon" style="width:100px; height:50px;">
                        </h3>
                        <p>Gerencie sua equipe com eficiÃªncia. Ferramentas essenciais para administraÃ§Ã£o de funcionÃ¡rios, cargos, salÃ¡rios e tudo que seu RH precisa.</p>
                        <ul class="feature-list">
                            <li>GestÃ£o de FuncionÃ¡rios</li>
                            <li>GestÃ£o de Recrutamento</li>
                            <li>Controle de SalÃ¡rios</li>
                            <li>AdministraÃ§Ã£o de Cargos</li>
                            <li>e muito mais.</li>
                        </ul>
                    </div>
                    <div class="dropdown-box dropdown-box-emprego">
                        ...
                        <p>Conecte talentos Ã  sua empresa. Publique vagas diretamente no SAM RH e facilite a contrataÃ§Ã£o dos melhores candidatos.</p>
                        <ul class="feature-list">
                            <li>PublicaÃ§Ã£o de Vagas</li>
                            <li>Triagem de Candidatos</li>
                            <li>ConexÃ£o com Empresas</li>
                            <li>Facilidade na ContrataÃ§Ã£o</li>
                            <li>e mais</li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="dropdown">
                <a href="#" class="dropbtn">Funcionalidades â–¾</a>
                <div class="dropdown-content">
                    <div class="dropdown-box dropdown-box-rh">
                        <h3>
                            <img src="img/sam2logo-32.png" alt="SAM RH" class="logo-icon" style="width:100px; height:50px">
                        </h3>
                        <p>ConheÃ§a todas as funcionalidades disponÃ­veis para otimizar os processos do seu RH.</p>
                        <ul class="feature-list">
                            <li>AutomaÃ§Ã£o de Processos</li>
                            <li>Controle de Ponto</li>
                            <li>GestÃ£o de BenefÃ­cios</li>
                            <li>e muito mais.</li>
                        </ul>
                    </div>
                    <div class="dropdown-box dropdown-box-emprego">
                        ...
                        <p>Explore os diversos recursos que facilitam a gestÃ£o do capital humano da sua empresa.</p>
                        <ul class="feature-list">
                            <li>IntegraÃ§Ã£o com Sistemas</li>
                            <li>CustomizaÃ§Ã£o</li>
                            <li>Compliance</li>
                            <li>e mais</li>
                        </ul>
                    </div>
            ...
            <form id="companyForm" action="registro_adm.php" method="POST">
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <div class="alert-container"> <!-- Novo contÃªiner para alinhar Ã­cone e texto -->
    ...
    <script>
        ...
        document.querySelector("#companyForm").addEventListener("submit", function(event) {
            event.preventDefault(); // Evita envio antes da modificaÃ§Ã£o
            ...
            if (!nome || !email || !senha || !telefone) {
                Swal.fire('Erro!', 'Todos os campos sÃ£o obrigatÃ³rios!', 'error');
                return;
            }
            ...
            if (!emailRegex.test(email)) {
                Swal.fire('Erro!', 'E-mail invÃ¡lido!', 'error');
                return;
            }
            ...
            if (!iti.isValidNumber()) {
                Swal.fire('Erro!', 'NÃºmero de telefone invÃ¡lido!', 'error');
                return;
            }

            hiddenInput.value = telefone; // Define o telefone formatado no campo oculto
            this.submit(); // Agora submete o formulÃ¡rio corretamente
        });
